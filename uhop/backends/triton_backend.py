...
class TritonBackend(Backend):
    ...
    def initialize(self) -> bool:
        ...
        try:
            ...
            logger.warning(
                "[Triton] triton not available (install with: pip install triton)"
            )
    ...
    def _setup_triton_kernels(self):
        ...
        logger.debug(
            f"[Triton] Registered {len(self._autogen_kernels)} autogen kernels"
        )

    def compile_kernel_from_template(
        self, op_name: str, template: str
    ) -> Optional[Callable]:
        """
