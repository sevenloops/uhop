...
extern "C" __global__ void conv2d_input_grad(const float *__restrict__ grad_out,
...
conv2d_weight_grad(const float *__restrict__ input,
                   const float *__restrict__ grad_out,
                   float *__restrict__ grad_w, int N, int Cin, int H, int W,
                   int Cout, int KH, int KW, int outH, int outW, int stride_h,
