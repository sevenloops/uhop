        ...
        <div className="max-w-4xl mx-auto space-y-12">
          ...
          <section className="space-y-6">
            ...
            <Card className="p-6 bg-card/50">
              <p className="text-muted-foreground leading-relaxed mb-4">
                UHop represents the foundation of a future where developers no
                longer need to write hardware-specific code. By leveraging AI to
                generate, validate, and optimize kernels, we're building a
                universal abstraction layer that makes high-performance
                computing accessible to everyone.
              </p>
              <p className="text-muted-foreground leading-relaxed">
                Our long-term vision extends beyond kernel optimization to
                encompass intelligent system-level resource management,
                predictive performance modeling, and adaptive runtime
                optimization that learns from usage patterns to continuously
                improve.
              </p>
            </Card>
          </section>
              ...
              <div className="flex flex-col md:flex-row gap-8 items-center">
                ...
                <div className="flex-1 text-center md:text-left space-y-4">
                  ...
                  <p className="text-sm text-muted-foreground leading-relaxed">
                    Passionate about building systems that bridge the gap
                    between cutting-edge research and practical applications.
                    UHop emerged from a vision to make hardware optimization
                    accessible through AI, eliminating the need for specialized
                  ...
                  <div className="flex gap-3 justify-center md:justify-start">
                    ...
                    <Button variant="outline" size="sm" asChild>
                      <a
                        href="https://www.linkedin.com/in/danielbisina"
                        target="_blank"
                        rel="noopener noreferrer"
                      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-muted-foreground">
                    <li>
                      • Python runtime with C++ performance-critical paths
                    </li>
          ...
          <section className="space-y-6">
            ...
            <Card className="p-8 bg-gradient-to-r from-primary/10 to-secondary/10 border-primary/20 text-center space-y-4">
              <p className="text-muted-foreground">
                UHop is open source and welcomes contributions from the
                community. Whether you're interested in adding new operations,
                improving kernel generation, or optimizing for new hardware
                platforms, we'd love to collaborate.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Button size="lg" variant="outline" asChild>
                  <a href="mailto:danbis664@gmail.com">Contact Us</a>
                </Button>
              </div>
            </Card>
          </section>
