...
def test_write_kpi_snapshot(tmp_path):
    ...
    (cache_dir / "autotune.json").write_text(
        '{"opencl|matmul|matmul_tiled|MockDevice|N64_M64_K64": {"last_ms": 0.5, "last_gflops": 10.0}, "opencl|conv2d|im2col_gemm|MockDevice|N1_C3_H32_W32_K16": {"last_ms": 1.2, "im2col_ms": 0.3, "gemm_ms": 0.7, "copy_ms": 0.2, "chunked": true, "chunk_count": 2, "var_ms": 0.05, "retune_suggested": false}}'
    )
